 ...
 */
public class CraftingTableIVRenderer extends TileEntityRenderer<TileEntityCraftingTableIV> {
    ...
    @Override
    public void render(TileEntityCraftingTableIV tile, double x, double y, double z, float partialTicks, int destroyStage) {
